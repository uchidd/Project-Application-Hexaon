...
export default class ModalEditUserAuthority extends Component {
    render() {
        return (
                ...
                <View style={styles.mainView}>
                    ...
                    <View style={styles.contentView}>
                        ...
                        <View style={styles.row}>
                            ...
                            <View style={styles.rightView}>
                                <TextInput style={styles.inputText} defaultValue={this.props.nikModal} multiline></TextInput>
                            </View>
                        </View>
                        <View style={styles.row}>
                            <View style={styles.leftView}>
                        ...
                        <View style={styles.row}>
                            ...
                            <View style={styles.rightView}>
                                <TextInput style={styles.inputText} defaultValue={this.props.roleModal} multiline></TextInput>
                            </View>
                        </View>
                        <View style={styles.row}>
                            <View style={styles.leftView}>
                        ...
                        <View style={styles.rowBottom}>
                            ...
                            <View style={styles.rightView}>
                                <TextInput style={styles.inputText} defaultValue={this.props.join_dateModal} multiline></TextInput>
                            </View>
                        </View>
                    </View>
